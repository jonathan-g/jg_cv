\item Mar\'{i}a Fernanda ``Ferna'' Alvarez-Carrascal
  (Ph.D. 2026, Earth \& Environmental Sciences).
  Dissertation advisor.
\item Christopher Tasich (Ph.D. 2023, Earth \& Environmental Sciences).
  Principal dissertation advisor, with co-advisor George Hornberger.
  Current position: U.S. Presidential Management Fellow at Environmental
  Protection Agency.
\item Wenwen ``Bowen'' He (Ph.D. 2023, Civil \& Environmental Engineering)
  Principal dissertation advisor, with co-advisor Janey Camp.
  Current position: Director of Training, Operations, and Data Management,
  Sungrow Power, Houston, TX.
